...
class Window(QMainWindow,QWidget):
    ...
    def file2qr_reset(self):
        ...
        if not self.window.file2qr_dont_reset_destination.isChecked():
            self.window.file2qr_destination.setText("./qr")
    ...
    def setup_buttons(self):
        ...
        self.window.file2qr_reset.clicked.connect(self.file2qr_reset)
